    ...
    public static class SmartObjectEditorMenus
    {
        ...
        private static void OnSceneGUI(SceneView sceneView)
        {
            ...
            if (e.type == EventType.KeyDown && e.keyCode == KeyCode.Space && !e.shift && !e.control && !e.alt)
            {
                ...
                menu.AddItem(new GUIContent("Smart Objects/Smart Object Group"), false, () =>
                {
                    CreateSmartObjectGroupAt(spawnPos, spawnNormal, sceneView);
                });
                ...
                menu.AddItem(new GUIContent("Smart Objects/Tunnel"), false, () =>
                {
                    CreateTunnelAt(spawnPos, spawnNormal, sceneView);
                });
        ...
        private static void CreateTunnelAt(Vector3 position, Vector3 normal, SceneView sceneView)
        {
            var go = new GameObject("TunnelSmartObject");
            go.transform.position = position;
        ...
        private static void CreateSmartObjectGroupAt(Vector3 position, Vector3 normal, SceneView sceneView)
        {
            var go = new GameObject("SmartObjectGroup");
            go.transform.position = position;
